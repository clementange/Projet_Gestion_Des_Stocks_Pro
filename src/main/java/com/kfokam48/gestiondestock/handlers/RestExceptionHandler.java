package com.kfokam48.gestiondestock.handlers;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  /**
   * Filet de securite : toute exception non geree explicitement ailleurs (ex. FlickrException
   * lors de l'upload de photo, checked exception propagee sans mapping) repartait auparavant
   * avec un statut/format incoherent selon le point exact de propagation, au lieu du format JSON
   * structure utilise partout ailleurs dans l'API.
   */
